...
const url = 'https://syhnserkan.com/guides';
const title = 'Guides – Serkan Sayhan';
const description = 'Guides for all kinds of javascript tutorials which written from scratch.';
