...
const MDXComponents = {
  ...
  td: TData,
  a: CustomLink,
  p: (props: any) => <Text as="p" mt={4} fontSize="17px" lineHeight="1.7" {...props} />,
  ul: (props: any) => <Box as="ul" pt={2} fontSize="17px" pl={4} ml={2} {...props} />,
  ol: (props: any) => <Box as="ol" pt={2} fontSize="17px" pl={4} ml={2} {...props} />,
  li: (props: any) => <Box as="li" pb={1} fontSize="17px" {...props} />,
  blockquote: Quote,
};
