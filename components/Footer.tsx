...
const Footer = () => {
  return (
    ...
    >
      ...
      >
        <StyledLink href="https://github.com/syhnserkan" title="GitHub" isExternal>
          <Button color="gray.500" variant="ghost">
            <Icon aria-label="Twitter" name="github" size="1.5rem" />
          </Button>
        </StyledLink>
        <StyledLink
          href="https://www.linkedin.com/in/serkan-sayhan-813b66173/"
          title="LinkedIn"
          isExternal
        >
          <Button color="gray.500" variant="ghost">
        ...
        <StyledLink href="mailto:syhnserkan@gmail.com" title="Email" isExternal>
          <Button color="gray.500" variant="ghost">
            <Icon aria-label="Email" name="mail" size="1.5rem" />
          </Button>
        </StyledLink>
        <StyledLink href="https://www.codewars.com/users/codepumps" title="Codewars" isExternal>
          <Button color="gray.500" variant="ghost">
